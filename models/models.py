...
class VAE(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            physical_cons = tf.math.reduce_mean(physical_constrained_loss(data,reconstruction,self.cfg.Train.physical_cons_coef))
            total_loss = reconstruction_loss + kl_loss + physical_cons
            if self.apply_supervision:
